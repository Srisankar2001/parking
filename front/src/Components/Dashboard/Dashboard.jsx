    ...
    <div className='dashboard'>
      <div className='dashboard-container'>
        <div className='dashboard-header'>
          ...
          {(revenue.twoWheeler !== null) && <div className='dashboard-header-two'>
            <h5>Bike</h5>
            <h3>{Number(revenue.twoWheeler).toFixed(2)} LKR</h3>
          </div>}
          {(revenue.threeWheeler !== null) && <div className='dashboard-header-three'>
            <h5>Auto</h5>
            <h3>{Number(revenue.threeWheeler).toFixed(2)} LKR</h3>
          </div>}
          {(revenue.fourWheeler !== null) && <div className='dashboard-header-four'>
            <h5>Car</h5>
